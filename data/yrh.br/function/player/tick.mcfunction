...
## 初回登録
    execute if entity @s[tag=!yrh.br.player.registered] run function yrh.br:system/register_player/root
...
## Radial Menu
    execute unless entity @s[type=mannequin] run function yrh.br:player/ui/radial_menu/root
