#|| --- CrossRefs --- ||#
#|| @yrh.br:player/ui/radial_menu/start
#||
#||    # function
...
## なんのmenu?
    ...
    $data modify storage yrh.br:ui player_data."$(UUID)".radial_menu.category set from entity @n[tag=yrh.br.player.ui.radial_menu.tmp_chest] Items[{Slot:0b}].components."minecraft:custom_data".yrhbr.item.use_radial_menu.category
