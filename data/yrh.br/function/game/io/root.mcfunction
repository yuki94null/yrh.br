...
## 今の人数
    execute store result storage yrh.br:game CurrentPlayerCount int 1.0 if entity @a
...
## プレイヤーリスト
    ...
    ### 移したので作り直す
        ...
        execute as @a run function yrh.br:game/io/create_player_list with entity @s
...
## 減った増えた？
    ### 減った
        execute if predicate \
            ...
            as @a run \
                function yrh.br:game/io/negative/root with entity @s
    ...
    ### 増えた
        execute if predicate \
            {\
                ...
                function yrh.br:game/io/positive/root
